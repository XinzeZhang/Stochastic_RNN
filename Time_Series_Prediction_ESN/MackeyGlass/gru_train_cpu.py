...
if __name__ == '__main__':
    ...
    plt.plot(gru_loss)
    plt.title('Loss of Training RNN with GRUs \n (Final MSE: %0.8f, Total Time: %i s)' % (gru_loss[-1], time.time()-time_tr_start))
    plt.savefig('MackeyGlass_Loss_GRU.png')
    # plt.show()
    ...
    # draw(y[2], 'b')
    # plt.show()
    plt.savefig('MackeyGlass_GRU.png')
    # plt.close()}