...
class SimpleESN(BaseEstimator, TransformerMixin):
    ...
    def _fit_transform(self, X):
        ...
        self.components_ = zeros(shape=(1 + n_features + self.n_components, n_samples))
        ...
        for t in range(n_samples):
            ...
            curr_ = (1 - self.damping) * curr_ + self.damping * tanh(self.input_weights_.dot(u) + self.weights_.dot(curr_))
            self. [:, t] = vstack((u, curr_))[:, 0]
